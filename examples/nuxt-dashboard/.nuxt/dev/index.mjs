...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getQuery as getQuery$1, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, getRouterParam, setHeader, getHeader, sendStream, getResponseStatusText } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/h3@1.15.11/node_modules/h3/dist/index.mjs';
...
import destr, { destr as destr$1 } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/destr@2.0.5/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/hookable@5.5.3/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/ofetch@1.5.1/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/node-mock-http@1.0.4/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/unstorage@1.17.5_aws4fetch@1.0.20_db0@0.3.4_drizzle-orm@0.45.2__ioredis@5.10.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/unstorage@1.17.5_aws4fetch@1.0.20_db0@0.3.4_drizzle-orm@0.45.2__ioredis@5.10.1/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/ohash@2.0.11/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/klona@2.0.6/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/defu@6.1.7/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/scule@1.3.0/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/unctx@2.5.0/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/radix3@1.1.2/node_modules/radix3/dist/index.mjs';
import consola, { consola as consola$1 } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/consola@3.4.2/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/youch-core@0.3.3/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/youch@4.1.1/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/source-map@0.7.6/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/devalue@5.7.1/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/errx@0.1.0/node_modules/errx/dist/index.js';
import { isVNode, isRef, toValue } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/vue@3.5.32_typescript@6.0.2/node_modules/vue/index.mjs';
import _wH6JrtIxmaSoA8lCPWFnE9z4lQeXW6H5z3l5aymEQw from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/@nuxt+vite-builder@4.4.2_9dccdc838464f28dbe16339a64556f35/node_modules/@nuxt/vite-builder/dist/fix-stacktrace.mjs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/pathe@2.0.3/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/unhead@2.1.13/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/vue@3.5.32_typescript@6.0.2/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///home/harlan/pkg/gscdump/node_modules/.pnpm/unhead@2.1.13/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/home/harlan/pkg/gscdump/examples/nuxt-dashboard/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "defaultUserId": "local",
    "defaultSiteId": "d_nuxtseo.com"
  },
  "gscDataDir": "/home/harlan/.gscdump/data",
  "r2AccountId": "",
  "r2AccessKeyId": "",
  "r2SecretAccessKey": "",
  "r2Bucket": "",
  "gscUserId": "local",
  "gscSiteId": "d_nuxtseo.com"
};
const envOptions = {
  prefix: "NITRO_",
...
const rootDir = "/home/harlan/pkg/gscdump/examples/nuxt-dashboard";
...
const _4yAZ5VlAOVf0oge8Ea4TQThUoPLCc5bRWCjx2ZxUGx0 = (nitroApp) => {
...
const plugins = [
  _4yAZ5VlAOVf0oge8Ea4TQThUoPLCc5bRWCjx2ZxUGx0,
...
const _1Br8pY = eventHandler((event) => {
...
const getServerEntry = () => import('file:///home/harlan/pkg/gscdump/examples/nuxt-dashboard/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
// @ts-expect-error file will be produced after app build
const getClientManifest = () => import('file:///home/harlan/pkg/gscdump/examples/nuxt-dashboard/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
// -- SSR Renderer --
...
const _lazy_rQzRqz = () => Promise.resolve().then(function () { return analysisSources_get$1; });
...
const handlers = [
  { route: '', handler: _1Br8pY, lazy: false, middleware: true, method: undefined },
  { route: '/api/analysis-sources', handler: _lazy_rQzRqz, lazy: true, middleware: false, method: "get" },
  ...
  { route: '/**', handler: _lazy_JkoQ3k, lazy: true, middleware: false, method: undefined }
];
...
const analysisSources_get = defineEventHandler(async (event) => {
  ...
  for (const table of TABLES) {
    const monthsCovered = (_b = coveredMonthsByTable.get(table)) != null ? _b : /* @__PURE__ */ new Set();
  ...
  return { tables, generatedAt: (/* @__PURE__ */ new Date()).toISOString() };
});

const analysisSources_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
...
function createR2Client(opts) {
  ...
  async function presignGet(key, expiresIn = DEFAULT_EXPIRES_S) {
...
const manifest_get = defineEventHandler(async (event) => {
  var _a, _b;
  const cfg = useRuntimeConfig();
  const userId = (_a = getQuery$1(event).user) != null ? _a : cfg.gscUserId;
  const siteId = (_b = getQuery$1(event).site) != null ? _b : cfg.gscSiteId;
  if (!userId)
  ...
  if (cfg.gscDataDir) {
    ...
    const entries2 = parsed.entries.filter((e) => e.userId === userId && (!siteId || e.siteId === siteId));
    return { version: 1, entries: entries2, watermarks: [] };
  }
...
const ____path__get = defineEventHandler(async (event) => {
  ...
  const r2 = useR2Client();
  const sizeHint = getQuery$1(event).s;
...
const signUrl_get = defineEventHandler(async (event) => {
  ...
  if (allowedUser && !key.startsWith(`u_${allowedUser}/`))
    throw createError({ statusCode: 403, statusMessage: "key outside allowed prefix" });
  const r2 = useR2Client();
  const expiresIn = Number((_a = getQuery$1(event).ttl) != null ? _a : 3600);
  const url = await r2.presignGet(key, expiresIn);
  return { url, expiresIn };
});

const signUrl_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: signUrl_get
}, Symbol.toStringTag, { value: 'Module' }));

const signUrls_post = defineEventHandler(async (event) => {
  const body = await readBody(event);
  const keys = Array.isArray(body == null ? void 0 : body.keys) ? body.keys.filter((k) => typeof k === "string") : [];
  if (keys.length === 0)
  ...
  const r2 = useR2Client();
  const expiresIn = typeof (body == null ? void 0 : body.ttl) === "number" ? body.ttl : 3600;
  const entries = await Promise.all(
    keys.map(async (key) => [key, await r2.presignGet(key, expiresIn)])
  );
  return { urls: Object.fromEntries(entries), expiresIn };
});

const signUrls_post$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: signUrls_post
}, Symbol.toStringTag, { value: 'Module' }));
