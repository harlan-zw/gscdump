 ...
 *
 * Counts source files in `packages/nuxt` and asserts the total
...
const LAYER_DIR = join(process.cwd(), 'packages/nuxt')
...
describe('layer file-count budget', () => {
  it(`@gscdump/nuxt stays under ${FILE_BUDGET} source files`, async () => {
