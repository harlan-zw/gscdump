...
const METRICS: Record<string, Metric> = {
  ...
  baselineClicks: { label: 'Previous', unit: 'count' },
  prevClicks: { label: 'Previous', unit: 'count' },
  ctr: { label: 'CTR', unit: 'ratio' },
  avgCtr: { label: 'CTR', unit: 'ratio' },
  position: { label: 'Avg position', unit: 'position' },
  avgPosition: { label: 'Avg position', unit: 'position' },
