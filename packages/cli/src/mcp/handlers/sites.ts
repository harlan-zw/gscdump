import type { ApiSite, ApiSitemap, Site } from 'gscdump/sites'
import type { z } from 'zod'
import type { HandlerContext, listSitemapsInput, listSitesInput, sitemapInput } from '../types'
import { fetchSitemaps, fetchSites, fetchSitesWithSitemaps, deleteSitemap as gscDeleteSitemap, fetchSitemap as gscFetchSitemap, submitSitemap as gscSubmitSitemap } from 'gscdump/sites'
