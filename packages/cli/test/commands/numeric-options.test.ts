...
vi.mock('../../src/analysis-local', () => ({ resolveAnalysisSource: boundary.analysis, analyzerTables: () => [], analysisNeeds: () => [] }))
...
describe('cLI numeric options', () => {
  ...
  it('forwards positive Analyzer limits and week counts', async () => {
    ...
    boundary.analysis.mockResolvedValueOnce({ runAnalysis, anchor: '2026-08-23' })
