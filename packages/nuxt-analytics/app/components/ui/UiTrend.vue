...
<template>
  ...
  <span v-else-if="trend === 0" data-ui="UiTrend" class="text-dimmed" :class="sizes[size as keyof typeof sizes]">—</span>
  ...
  <!-- Standard trend mode -->
  <span v-else data-ui="UiTrend" class="inline-flex gap-px items-center whitespace-nowrap leading-none tabular-nums font-semibold tracking-tight ml-1" :class="classes">
    <UIcon
      v-if="iconOnly"
      :name="trendIcon"
