...
[![npm version](https://img.shields.io/npm/v/@gscdump/engine-wasm?color=yellow)](https://npmjs.com/package/@gscdump/engine-wasm)
[![npm downloads](https://img.shields.io/npm/dm/@gscdump/engine-wasm?color=yellow)](https://npm.chart.dev/@gscdump/engine-wasm)
...
```bash
npm install @gscdump/engine-wasm @duckdb/duckdb-wasm
```
...
```ts
import { createEngine } from '@gscdump/engine-wasm'
