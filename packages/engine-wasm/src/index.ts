/**
 * @gscdump/engine-wasm — typed DuckDB-WASM analytics primitives.
 *
...
export type { ComparisonMode, ResolvedWindow, ResolveWindowOptions, WindowPreset } from '@gscdump/analysis/period'
