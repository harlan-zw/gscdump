/**
 * SQLite query-source adapter: wraps a sqlite-proxy-style executor (D1, libsql, sqlite3+
...
export function createSqliteQuerySource(config: SqliteQuerySourceOptions): AnalysisQuerySource {
