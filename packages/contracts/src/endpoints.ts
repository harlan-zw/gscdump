...
export const partnerEndpoints = {
  ...
  submitSitemap: defineEndpoint('POST', partnerRoutes.sites.sitemaps, noSchema),
  refreshSitemaps: defineEndpoint('POST', partnerRoutes.sites.sitemaps, noSchema),
  ...
  requestIndexingInspect: defineEndpoint('POST', partnerRoutes.sites.indexingInspect, partnerControlEndpointSchemas.getIndexingInspect),
  ...
  renameTeam: defineEndpoint('PATCH', partnerRoutes.teams.byId, noSchema),
  deleteTeam: defineEndpoint('DELETE', partnerRoutes.teams.byId, noSchema),
  ...
  updateTeamMemberRole: defineEndpoint('PATCH', partnerRoutes.teams.member, noSchema),
  removeTeamMember: defineEndpoint('DELETE', partnerRoutes.teams.member, noSchema),
