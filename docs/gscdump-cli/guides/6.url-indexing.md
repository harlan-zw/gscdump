---
title: URL inspection and indexing
description: Inspect URLs, manage sitemaps, and send eligible indexing notifications with gscdump.
---
...
Google allows [2,000 URL inspections per day and 600 per minute](https://developers.google.com/webmaster-tools/limits) for each property.
...
The local quota ledger tracks Indexing API publish calls made through this Store.
Calls from other tools still count against your Google project’s quota.
...
Submission does not guarantee crawling or indexing.
