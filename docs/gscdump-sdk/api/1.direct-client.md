...
Hosted gscdump.com clients live in [the hosted SDK](./2.hosted-http.md). Storage engines and analyzers live in [`@gscdump/engine`](https://www.npmjs.com/package/@gscdump/engine) and [`@gscdump/analysis`](https://www.npmjs.com/package/@gscdump/analysis).
